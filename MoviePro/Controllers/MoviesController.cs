...
namespace MoviePro.Controllers
{
    public class MoviesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,MoiveId,Title,TagLine,Overview,ReleaseDate,Trailer")] Movie movie, IFormFile Poster, IFormFile BGImage)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,MoiveId,Title,TagLine,Overview,ReleaseDate,Poster,ContentType,BGImage,BGContentType,Trailer")] Movie movie, IFormFile NewPoster, IFormFile NewBGImage)
        {
            if (id != movie.Id)
            {
                return NotFound();
